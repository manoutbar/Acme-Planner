...
public class AuthenticatedTaskListTest extends AcmePlannerTest {
	...
	@Order(20)
	public void listAllNegative(final int recordIndex, final String executionStart, final String executionEnd, final String title, final String isPublic, final String workload, final String link, final String description) {
		super.signIn("administrator", "administrator");
		super.clickOnMenu("Authenticated", "List tasks");
